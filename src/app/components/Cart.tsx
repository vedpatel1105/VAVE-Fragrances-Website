...
export default function Cart({ isOpen, setIsOpen, cart, total, updateQuantity, removeFromCart, checkout }: CartProps) {
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-y-0 right-0 w-full sm:w-96 bg-white dark:bg-gray-900 shadow-lg z-50 flex flex-col"
          >
            ...
            {cart.length > 0 && (
              <div className="p-6 border-t border-gray-200 dark:border-gray-800">
                ...
                <div className="space-y-3">
                  <Button onClick={handleCheckout} disabled={cart.length === 0} className="w-full py-6 h-auto">
                ...
                {total < 1000 && (
                  <p className="mt-4 text-sm text-center text-gray-500 dark:text-gray-400">
                    Add {formatCurrency(1000 - total)} more to get free shipping!
                  </p>
                )}
              </div>
            )}
