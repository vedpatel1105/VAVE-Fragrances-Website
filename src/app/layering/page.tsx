        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-400 leading-relaxed">
              Layering is the art of combining two different fragrances to create your own unique scent. Simply choose
              any two of our perfumes and wear them together - the scents will blend on your skin to form a completely
              new fragrance that's uniquely yours. It's like being your own perfumer!
            </p>
          </div>
        </div>
